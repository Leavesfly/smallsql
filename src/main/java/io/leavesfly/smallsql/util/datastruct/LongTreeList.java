 ...
 * @author Volker Berlin
 */
public final class LongTreeList {
...
//    }
     ...
     * @param value
     */
    public LongTreeList(long value) throws SQLException {
        this();
        add(value);
    }
     ...
     */
    public LongTreeList(StoreImpl input) {
     ...
     * @param output
     */
    public final void save(StoreImpl output) {
     ...
     * @throws SQLException
     */
    public final void add(long value) throws SQLException {
        offset = 0;
        if (size == 0) {
     ...
     * @throws SQLException
     */
    public final void remove(long value) throws SQLException {
        if (size == 0) return;
        int offset1 = 0;
        int offset2 = 0;
        int offset3 = 0;
     ...
     * @return
     */
    public final long getNext(LongTreeListEnum listEnum) {
     ...
     * @return
     */
    public final long getPrevious(LongTreeListEnum listEnum) {
        int shift = (3 - listEnum.stack) << 4;
