...
public class MutableNumeric extends Number implements Mutable {
	...
	public MutableNumeric(int complement) {
		if (complement == 0) {
			signum = 0;
			value = EMPTY_INTS;
		} else {
	...
	public MutableNumeric(long complement, int scale) {
		this(complement);
		this.scale = scale;
	}

	public MutableNumeric(double val) {
	...
	public MutableNumeric(String val) {
		this(new BigDecimal(val));
	}

	public MutableNumeric(BigDecimal big) {
		this(big.unscaledValue().toByteArray());
		scale = big.scale();
	}

	public MutableNumeric(int signum, int[] value, int scale) {
		this.signum = signum;
		this.value = value;
		this.scale = scale;
	}

	public MutableNumeric(MutableNumeric numeric) {
	 ...
	 *            the added value
	 */
	public void add(MutableNumeric num) {
		if (num.scale < scale) {
			num.setScale(scale);
	 ...
	 */
	public void sub(MutableNumeric num) {
		if (num.scale < scale) {
			num.setScale(scale);
		} else if (num.scale > scale) {
			setScale(num.scale);
	...
	public void mul(MutableNumeric num) {
		// TODO performance
	...
	public final void mul(int factor) {
		if (factor < 0) {
			factor = -factor;
			signum = -signum;
		}
	...
	public void div(MutableNumeric num) {
		// TODO performance
	...
	public final void div(int quotient) {
	...
	public void mod(MutableNumeric num) {
		// TODO performance
