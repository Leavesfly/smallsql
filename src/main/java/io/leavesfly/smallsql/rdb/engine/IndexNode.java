...
public class IndexNode {
	...
	public final IndexNode[] getChildNodes() {
		return nodes;
	}
	...
	protected void save(StoreImpl output) throws SQLException {
	...
	protected void saveRef(StoreImpl output) throws SQLException {
	...
	protected void load(StoreImpl input) throws SQLException {
