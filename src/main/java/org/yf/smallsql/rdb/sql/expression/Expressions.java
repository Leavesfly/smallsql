...
public final class Expressions {
	...
	public final Expression get(int idx) {
		if (idx >= size)
	...
	public final void add(int idx, Expression expr) {
		if (size >= data.length) {
			resize(size << 1);
		}
	...
	public final void addAll(Expressions cols) {
		int count = cols.size();
	...
	public final void set(int idx, Expression expr) {
		data[idx] = expr;
	}

	public final int indexOf(Expression expr) {
		if (expr == null) {
	...
	public final Expression[] toArray() {
