 ...
 */
package org.yf.smallsql.rdb.engine.index;
...
import org.yf.smallsql.rdb.engine.store.CreateFile;
...
public final class IndexDescription {
	 ...
	 */
	public IndexDescription( String name, String tableName, int constraintType, Expressions expressions, Strings columns){
	...
	public final Strings getColumns(){
		return columns;
	}
	 ...
	 */
	final void init(Database database, View tableView)/* throws Exception*/{
	 ...
	 */
	final void create(SsConnection con, Database database, View tableView) throws Exception{
	 ...
	 */
	public final void writeExpression( int columnIdx, Expression valueExpression) {
	 ...
	 */
	public final void writeFinish(SsConnection con) {
		//TODO
	 ...
	 */
	public final void save(StoreImpl store) throws SQLException{
	 ...
	 */
	public final static IndexDescription load(Database database, View tableView, StoreImpl store) throws SQLException{
