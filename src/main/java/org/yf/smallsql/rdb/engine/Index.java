...
import org.yf.smallsql.util.datastruct.LongTreeList;
...
public class Index{
	...
	protected final IndexNode rootPage;
    ...
    protected Index(IndexNode rootPage){
        this.rootPage = rootPage;
    }
    
    
	public IndexScrollStatus createScrollStatus(Expressions expressions){
     ...
     */
	public final Object findRows(Expressions expressions, boolean searchNullValues, ArrayList nodeList) throws Exception{
     ...
     *            optional, can be null. The search path in the index tree.
     */
    public final Object findRows(Expression[] expressions, boolean searchNullValues, ArrayList nodeList) throws Exception{
        IndexNode page = rootPage;
	 ...
	 */
	public final void addValues( long rowOffset, Expressions expressions ) throws Exception{
