...
import org.yf.smallsql.rdb.engine.index.IndexNodeScrollStatus;
...
import org.yf.smallsql.util.datastruct.LongTreeListEnum;

/**
 * This class save the status of the scrolling through a Index. This is like a Cursor.
 */
public class IndexScrollStatus {
	...
	public IndexScrollStatus(IndexNode rootPage, Expressions expressions){	
	 ...
	 */
	public final long getRowOffset( boolean scroll){
		if(longList != null){
