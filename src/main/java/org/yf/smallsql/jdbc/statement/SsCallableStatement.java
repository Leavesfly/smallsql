...
public class SsCallableStatement extends SsPreparedStatement implements CallableStatement {
	...
	public SsCallableStatement(SsConnection con, String sql) throws SQLException {
		super(con, sql);
	}

	public SsCallableStatement(SsConnection con, String sql, int rsType, int rsConcurrency) throws SQLException {
