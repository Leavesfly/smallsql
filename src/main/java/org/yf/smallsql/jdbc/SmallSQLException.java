 ...
 *
 */
public class SmallSQLException extends SQLException {
	 ...
	 */
	public static void setLanguage(Object localeObj) throws SQLException {
	...
	public static SQLException create(String messageCode) {
	 ...
	 *            message parameter.
	 */
	public static SQLException create(String messageCode, Object param0) {
	...
	public static SQLException createFromException(Throwable e) {
	 ...
	 *            message parameter.
	 */
	public static SQLException createFromException(String messageCode, Object param0, Throwable e) {
		String message = translateMsg(messageCode, new Object[] { param0 });
		String sqlState = language.getSqlState(messageCode);
		return new SmallSQLException(e, message, sqlState);
	}
	 ...
	 */
	public static String translateMsg(String messageCode, Object[] params) {
		assert (messageCode != null && params != null) : "Fill parameters. msgCode=" + messageCode + " params="
				+ params;
