...
public class TestOther extends BasicTestCase {
	...
	/**
	 * If a CHAR and a VARCHAR data type in a equals then both data type should
	 * be identical. This means the database must convert the CHAR to VARCHAR or
	 * vice versa. A static or dynamic string parameter has the data type
	 * VARCHAR
	 */
